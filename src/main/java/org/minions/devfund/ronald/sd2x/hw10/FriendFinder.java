package org.minions.devfund.ronald.sd2x.hw10;
...
public class FriendFinder {
	...
	public Set<String> findClassmates(Student theStudent) {
		...
		if (theStudent == null) throw new IllegalArgumentException("The hw10.Student input is incorrect");
		if (classesDataSource == null) throw new IllegalStateException("The classesDataSource input is incorrect");
		if (studentsDataSource == null) throw new IllegalStateException("The studentsDataSource input is incorrect");

		
		String name = theStudent.getName();

		if (name == null) throw new IllegalArgumentException("The students name could no be null");
		...
		for (String myClass : myClasses) {
			...
			for (Student student : students) {
				...
				if (theirClasses == null || theirClasses.isEmpty()) return null;
