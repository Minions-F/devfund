...
public class BattleshipTestGrader {
    ...
    public void testGetLength() {
        assertTrue(battleship.getLength() == 8);
        assertTrue(cruiser.getLength() == 6);
        assertTrue(destroyer.getLength() == 4);
    ...
    public void testOkToPlaceShipAt() {
        assertTrue("This battleship should have been ok to place", battleship.okToPlaceShipAt(11, 0, true, ocean1));
        assertFalse("Diagonal adjacency is not allowed", destroyer.okToPlaceShipAt(1, 4, true, ocean1)); // diagonally
        // touch
        assertTrue(destroyer.okToPlaceShipAt(0, 1, true, ocean1));
        assertFalse("Two ships cannot overlap", destroyer.okToPlaceShipAt(2, 2, true, ocean1)); // overlap
        assertFalse("Two ships cannot touch each other vertically", destroyer.okToPlaceShipAt(10, 3, false, ocean1)); // vertically
        // touch
        assertFalse("Placed a ship that stuck out of the ocean", cruiser.okToPlaceShipAt(0, 18, true, ocean1)); // stick
        // out
        assertFalse("Two ships cannot touch each other horizontally", submarine.okToPlaceShipAt(2, 4, true, ocean1)); // horizontally
        // touch
    }
    ...
    public void testPlaceShipAt() {
        ...
        assertTrue(cruiser.getBowRow() == 11);
        assertTrue(cruiser.getBowColumn() == 4);
        ...
        assertTrue(battleship.getBowColumn() == 6);
    ...
    public void testShootAt() {
        ...
        assertFalse("shooting the same spot after sinking should return false", battleship.shootAt(2, 3));
    ...
    public void testOcean() {
        assertTrue("checking that the ocean variable is an instance of the Ocean class ", ocean instanceof Ocean);
        assertEquals("The top left corner was expected to be empty ", ocean.getShipArray()[0][0].getShipType(),
                "empty");
        assertEquals("The bottom right corner was expecte to be empty ", ocean.getShipArray()[19][19].getShipType(),
                "empty");
    ...
    public void testPlaceAllShipsRandomly() {
        ...
        assertTrue(numEmptySeaBefore == 400);
        ...
        assertTrue(numBattleship == 8);
        assertTrue(numCruiser == 12);
        assertTrue(numDestroyer == 12);
        assertTrue(numSubmarine == 12);
        assertTrue(numEmptySeaAfter == 339);
    }
